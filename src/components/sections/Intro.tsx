...
export default function Intro() {
    return (
        <div className="component-Intro w-full pt-26 bg-linear-170 from-primary-light from-0% to-primary to-50% text-white text-center md:text-left wave-trim-bottom-mask">
            <div className="content-section flex flex-col md:flex-row items-center justify-between gap-15">
                <div className="md:w-3/5 md:mb-20">
                ...
                <div className="w-3/5 md:w-2/5 mx-auto text-center">
