...
class Processor
{
    ...
    public function launch($mustExit = true)
    {
        ...
        if (count($this->firewallRules) == 0 && count($this->whitelistRules) == 0 && (!is_array($this->firewallRulesLegacy) || is_array($this->firewallRulesLegacy) && count($this->firewallRulesLegacy) == 0)) {
            return true;
        }
        ...
        if (is_array($this->firewallRulesLegacy) && count($this->firewallRulesLegacy) > 0 && !$this->mustUsePluginCall && !$isWhitelisted) {
