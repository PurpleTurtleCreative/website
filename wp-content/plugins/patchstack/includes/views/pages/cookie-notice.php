...
<div class="patchstack-font">
	<form class="patchstack-form-wrap" method="post" action="<?php echo esc_attr( $form_action ); ?>">
		...
		<input type="hidden" value="patchstack_cookienotice_settings_group" name="option_page">
		<?php
			do_settings_sections( 'patchstack_cookienotice_settings' );
			settings_fields( 'patchstack_cookienotice_settings_group' );
