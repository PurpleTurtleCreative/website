			...
			<div class="col s12">
				<div class="card">
					...
					<div class="card-content">
						<h4><?php _e( 'Error Code', 'patchstack' ); ?> <?php echo esc_html( $fid ); ?></h4>
						<p><?php echo sprintf( __( 'This request has been blocked by <a href="%s" target="_blank">Patchstack</a> Web Application Firewall.', 'patchstack' ), 'https://patchstack.com' ); ?></p>
						<p><?php _e( 'If you are a legitimate user, contact the administrator of the site with above error code if this message persists.', 'patchstack' ); ?></p>
